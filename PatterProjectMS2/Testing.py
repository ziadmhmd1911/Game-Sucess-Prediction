...
class Testing:
    ...
    def SetNulls(self,data):
        ...
        data['Primary Genre'] = imputerPrimaryGenre.fit_transform(data['Primary Genre'].values.reshape(-1, 1))
        ##############################################################################################################
    ...
    def Drop(self,data):
        data.drop(["URL", "ID", "Name", "Subtitle", "Icon URL", "Description", "Developer"], axis=1, inplace=True)
        return data
